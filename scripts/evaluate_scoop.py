...
def compute_flow(scoop, batch, args):
    ...
    with torch.no_grad():
        ...
        feats_0, graph = scoop.extractor(pc_0)
        feats_1, _ = scoop.extractor(pc_1)
        ...
        for b in iterate_in_chunks(idx, args.nb_points_chunk):
            ...
            points_flow, points_conf, _,similarity_cross = scoop.get_recon_flow([points, pc_1_orig], [feats, feats_1_orig])
...
def eval_model(scoop, testloader, log_file, log_dir, res_dir, args):
    ...
    for it, batch in enumerate(tqdm(testloader)):
        ...
        if args.all_candidates:
            est_flow, corr_conf, graph,similarity_cross = compute_flow(scoop, batch, args)
        else:
            with torch.no_grad():
...
if __name__ == "__main__":
    ...
    parser.add_argument("--path2ckpt", type=str, default="/home/SCOOP/experiments/GOT_extractor/model_e100.tar", help="Path to saved checkpoint.")
