...
from models.extractor import GeoDGCNN_flow2
...
class MODEL(torch.nn.Module):
    def __init__(self, args):
        ...
        self.extractor = GeoDGCNN_flow2(k=32, emb_dims=128, dropout=0.5)
    ...
    def get_features(self, pcloud, nb_neighbors=32):
        ...
        graph : MODEL.models.graph.Graph
    ...
    def forward(self, pclouds):
        ...
        feats_0, graph = self.extractor(pclouds[0])
        feats_1, _ = self.extractor(pclouds[1])
        ...
        recon_flow, corr_conf, target_cross_recon,similarity_cross = self.get_recon_flow(pclouds, feats)
